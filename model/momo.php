<?php
function insert_momo($User_ID, $partnerCode, $orderId, $orderInfo, $price, $Method, $Status)
{
    $sql = "INSERT INTO bill (User_ID, partnerCode, orderId, orderInfo, price, Method, Status) 
    VALUES ('$User_ID','$partnerCode','$orderId','$orderInfo','$price','$Method','$Status')";
    pdo_execute($sql);
}
