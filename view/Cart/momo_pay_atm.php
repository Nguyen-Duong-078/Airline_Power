...
$orderInfo = "$Flight_Number _ Ngày bay: $formattedDate _ Khởi Hành: $Start_City-$Departure_Times _ Đến: $Arrival_City-$Arrival_Times";
$amount = $Price;
$orderId = time() . "";
$redirectUrl = "http://localhost/Project_One/view/Vnpay.php";
$ipnUrl = "http://localhost/Project_One/view/Vnpay.php";
$extraData = "";
