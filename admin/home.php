...
foreach ($revenue_book as $revenue_book) {
    extract($revenue_book);
}
?>
?>
<!-- APP CSS -->
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-6 col-md-12 col-xl-5">
                                                    <h3 style="font-size: calc(1.275rem + .3vw);" class="mb-2"><?= $CountTicket ?></h3>
                                ...
                                <div class="col-md-4 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-6 col-md-12 col-xl-5">
                                                    <h3 style="font-size: calc(1.275rem + .3vw);" class="mb-2"><?= $Count_huy ?></h3>
                                                    <div class="d-flex align-items-baseline">
